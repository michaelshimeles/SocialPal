    ...
    return (
        <div className='flex justify-center p-5 min-w-screen'>
            <div className='flex flex-col justify-center w-[70%] mt-5'>
                ...
                <p className="leading-7 [&:not(:first-child)]:mt-6">
                    Social Pal utilizes the TikTok API for some of its services. By using these features, you consent to the data practices as described in TikTok&apos;s Privacy Policy, which can be found at <a href="https://developers.tiktok.com/terms/">https://developers.tiktok.com/terms/</a>.
                </p>
